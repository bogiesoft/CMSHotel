...
<div class="block bg-image2">
    <div class="hide-opacity bounceInLeft container text-center">
            <h1 class="text-center text-uppercase"><strong>{{$title}}</strong></h1>
...
<div class="block">
    <div class="container">
        ...
        <h5 class="text-center" style="color: black; margin-bottom: 10vh">
            ...
            look no further than the legendary {{$title}}. Situated in the heart of Content City,
            ...
            @if($room)
                <a href="{{url('/rooms')}}">
                    <div class="col-xs-6 col-sm-4 col-md-4 text-center">
                        <div class="popular">
                            <img src="/images/rooms/{{$room->img}}" class="img-responsive img-circle center-block pulse">
