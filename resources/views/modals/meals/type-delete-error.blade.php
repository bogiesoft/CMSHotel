        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div style="padding: 1em">
                    <form id="" action="/dashboard/meal-types/{{$type->id}}" method="post">
                        {{csrf_field()}}
                        {{method_field('delete')}}
                        <div class="form-group">
                            <p class="text-center">
                                Some meals are of type: {{$type->name}}.<br>
                                Choose a different type for these meals or cancel.
                            </p>
                        ...
                        <div class="form-group">
                            <button type="submit" name="clear_meals" class="btn btn-info">Change</button>
